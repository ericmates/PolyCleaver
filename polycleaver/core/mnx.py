...
class BulkUnit():
    ...
    def __init__(self, bulk):
        ...
        self.atoms = bulk
        self.bulk = self
        set_site_attributes(self.atoms)
...
class SlabUnit(BulkUnit):
    ...
    def __init__(self, slab, bulk_obj):
        ...
        self.atoms = slab
        self.bulk = bulk_obj
        set_site_attributes(self.atoms) # Update attributes of periodic sites.
...
def generate_slabs(bulk, hkl, thickness=15, vacuum=15):
    ...
    initial_slabs = get_initial_slabs(bulk, hkl_list, thickness, vacuum)
